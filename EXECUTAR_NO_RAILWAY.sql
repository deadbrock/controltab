-- ========================================
-- EXECUTAR NO POSTGRESQL DO RAILWAY
-- ========================================
...
-- ========================================
-- IMPORTANTE: O hash abaixo é para a senha "Supersuti[1]"
-- Email: ti.services@lgservices.com.br
-- Se quiser outra senha, execute localmente: node gerar-hash-senha.js

INSERT INTO users (name, email, password, role, active)
VALUES (
  'Administrador',
  'ti.services@lgservices.com.br',
  '$2a$10$po9pevONRA0LEElAmbX2ZuiUFIVz/E6N1rlnaNdu9Uh1Wy.m8a9Gu',
  'admin',
  true
)
